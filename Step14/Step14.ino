/**************************************************************************
 ...
 Description:   This is the step #14 for building a WWVB Clock.
                In this sketch, a status indicator shows how
                recently time was successfully received and decoded.
                Re-synchronization is attempted when data is stale.
...
#include <TFT_eSPI.h>
#include <TimeLib.h>
#define TITLE "WWVB Step #14: CLOCK STATUS"
